...
c = (
    ...
    .add("Country", [list(z) for z in zip(data['国家_re'], data['paper'])], "world", is_map_symbol_show=False)
    ...
    .set_global_opts(
        ...
        visualmap_opts=opts.VisualMapOpts(max_=300),               # 注意此max的值 所有数据的颜色都根据值来渐变
    )
)
